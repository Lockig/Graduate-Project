        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container-fluid">
                <div class="card card-custom">
                    <form action="{{route('teacher.storeCourseMaterial',$course)}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-7 mt-4 ml-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  id="kt-ckeditor-3" type="text" name="description" class="form-control" placeholder="nhập nội dung">
                                    </textarea>
                                </div>
                            </div>
                            <div class="col-3 mt-4">
                                <div class="form-group">
                                    ...
                                    <input type="file" max="5" accept=".jpg,.jpeg,.png,.pdf,.docx" name="file_upload[]" multiple class="form-control" placeholder="nhập tiêu đề">
                                    <small>Tải lên tối đa 5 files/lần</small>
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-center mb-2">
                            <button class="btn btn-primary btn-hover-primary align-center" type="submit">Tạo học liệu</button>
                        </div>
                        @csrf
                    </form>
                </div>
