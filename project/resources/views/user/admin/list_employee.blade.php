                                ...
                                <div class="col-lg-9 col-xl-8">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-4 my-2 my-md-0">
                                            ...
                                            <button name="export" class="btn btn-light-primary px-6 font-weight-bold">Export</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td class="pr-0 text-right">
                                            <form method="post"  action="{{route('admin.user_promote',$user->user_id)}}" data-toggle="tooltip"
                                               title="Promote"
                                            ...
                                            <a href="{{route('admin.show',$user->user_id)}}" data-toggle="tooltip"
                                               title="thông tin"
