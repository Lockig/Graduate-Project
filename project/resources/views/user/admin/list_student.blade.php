        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Danh sách học sinh</h5>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">Danh sách học sinh</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="card card-custom gutter-b table-responsive">
                    ...
                    <div class="card-body">
                        <form method="get" action="{{route('admin.listStudent')}}" class="mb-7">
                            @csrf
                            <div class="row ">
                        ...
                        <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
                            ...
                            @foreach($students as $student)
                                <tr>
                                    ...
                                    <td class="pr-0">
                                            <span
                                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$student->id}}
                                            </span>
                                    </td>
                                    <td class="pr-0">
                                            <span
                                    ...
                                    <td class="pr-0 text-right">
                                        <a href="{{route('users.editInfos',$student)}}" data-toggle="tooltip"
                                           title="chỉnh sửa"
                                        ...
                                        <a href="{{route('users.show',$student)}}" data-toggle="tooltip"
                                        ...
                                        <form class="btn btn-icon btn-light btn-hover-primary btn-sm" method="post"
                                              action="{{route('users.destroy',$student)}}"
                                              data-toggle="tooltip"
                                              title="xóa">
                                            @csrf
                                            @method('DELETE')
