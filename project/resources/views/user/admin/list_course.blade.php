                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-12 col-xl-8">
                                    <div class="row align-items-center">
                                        ...
                                        {{--                                        <div class="col-md-4 my-2 my-md-0">--}}
                                        {{--                                            <div class="d-flex align-items-center">--}}
                                        {{--                                                <label class="mr-3 mb-0 d-none d-md-block">Position:</label>--}}
                            ...
                            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
                                ...
                                @foreach($courses as $course)
                                    <tr>
                                        ...
                                        <td>
                                           <span
                                               class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$course->start_date}}</span>
                                        </td>
                                        <td>
                                           <span
                                               class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$course->end_date}}</span>
                                        </td>
                                        <td>
                                           <span
