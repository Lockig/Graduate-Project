                        ...
                        <form method="get" action="{{route('admin.listCourse')}}" class="mb-7">
                            ...
                            <div class="row ">
                                <div class="col-lg-12 col-xl-8">
                                    <div class="row align-items-center ">
                                        <div class=" col-lg-5 my-2 my-md-0">
                            ...
                            <div class="row align-items-center mt-2">
                                <div class="col-md-12 my-2 my-md-0">
                                    <button class="btn btn-light-primary px-6 font-weight-bold">  <span class="svg-icon svg-icon-md">
                                    ...
                                    <a href="{{route('admin.createCourse')}}" class="btn btn-light-primary font-weight-bold">
                                            ...
                                            <ul class="navi flex-column navi-hover py-2">
                                                ...
                                                <li class="navi-item">
                                                    <form action="{{route('admin.listCourse')}}" method="get">
                                                        @csrf
                                                        <button name="export" type="submit" class="navi-link btn btn-borderless w-100">
                                                                    <span class="navi-con">
                            ...
                            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
                                ...
                                @foreach($courses as $course)
                                    <tr>
                                        ...
                                        <td class="pr-0">
                                            <span
                                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ucwords(\App\Models\User::find($course->teacher_id)->first_name) . ' ' . ucwords(\App\Models\User::find($course->teacher_id)->last_name) }}
                                            </span>
                                        </td>
                                        <td>
                                           <span
                                               class="text-dark-75 font-weight-bolder d-block font-size-lg">{{\Carbon\Carbon::parse($course->start_date)->format('d/m/Y')}}</span>
                                        </td>
                                        <td>
                                           <span
                                               class="text-dark-75 font-weight-bolder d-block font-size-lg">{{\Carbon\Carbon::parse($course->end_date)->format('d/m/Y')}}</span>
                                        </td>
                                        <td>
                                           <span
                                               class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$course->course_status}}</span>
                                        </td>
                                        <td class="pr-0 text-right">
                                            ...
                                            <a href="{{route('admin.coursesDetails',$course)}}"
                                               data-toggle="tooltip"
                                               title="thông tin"
