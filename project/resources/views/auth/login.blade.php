    ...
    <div class="login-form">
        ...
        <form class="form" id="kt_login_singin_form" action="/login" method="POST">
            ...
            <div class="pb-5 pb-lg-15">
                ...
                <h3 class="text-muted font-size-h4 font-size-h4-lg">Điền thông tin đăng nhập</h3>
            </div>
            <!--begin::Title-->
            <!--begin::Form group-->
            ...
            <div class="form-group">
                <div class="d-flex justify-content-between mt-n5">
                    <label for="password"
                           class="font-size-h6 font-weight-bolder text-dark pt-5">{{ __('Mật khẩu') }}</label>
                    <a href="/password-reset"
                    {{--                    <a href="{{ route('password.reset') }}"--}}
                       class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">{{__('Quên mật khẩu ?')}}</a>
                </div>
            ...
            <div class="pb-lg-0 pb-5">
                <button type="submit" id="kt_login_singin_form_submit_button"
                        class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">{{__('Đăng nhập')}}</button>
            </div>
            <!--end::Action-->
        </form>
        <!--end::Form-->
