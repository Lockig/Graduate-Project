    ...
    <div class="login-form">
        ...
        <form class="form" id="kt_login_forgot_form" action="{{route('sendMail')}}" method="post">
            ...
            <div class="pb-5 pb-lg-15">
                <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">{{__('Quên mật khẩu ?')}}</h3>
                <p class="text-muted font-weight-bold font-size-h4">{{__('Điền email để nhận mật khẩu mới')}}</p>
            </div>
            <!--end::Title-->
            <!--begin::Form group-->
            ...
            <div class="form-group d-flex flex-wrap">
                <button type="submit" id="kt_login_forgot_form_submit_button" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4">Gửi</button>
