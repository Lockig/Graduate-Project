<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <!--begin::Subheader-->
{{--                @include('layout.patials.sub_header')--}}
<!--end::Subheader-->
    <!--begin::Entry-->
                            ...
                            <div class="card-spacer mt-n25">
                                ...
                                <div class="row m-0">
                                    <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                        ...
                                        <a href="#" class="text-warning font-weight-bold font-size-h6">Weekly
                                            Sales</a>
                                    </div>
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header align-items-center border-0 mt-4">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span
                                    class="text-muted mt-3 font-weight-bold font-size-sm">890,344 Sales</span>
                            </h3>
                            <div class="card-toolbar">
                                <div class="dropdown dropdown-inline">
                                    <a href="#"
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span
                                    class="text-muted mt-3 font-weight-bold font-size-sm">Pending 10 tasks</span>
                            </h3>
                            <div class="card-toolbar">
                        ...
                        <div class="card-body pt-8">
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg">Concept
                                        Design</a>
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Functional
                                        Logics</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-vertical-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                                <span
                                                                    class="text-muted font-weight-500">ReactJS, Ruby</span>
                                                </td>
                                                <td class="text-right">
                                                                <span
                                                                    class="label label-lg label-light-warning label-inline">In Progress</span>
                                                </td>
                                                <td class="text-right pr-0">
                                                    <a href="#"
                                                       class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                                <span
                                                                    class="text-muted font-weight-500">ReactJs, HTML</span>
                                                </td>
                                                <td class="text-right">
                                                                <span
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                                <span
                                                                    class="text-muted font-weight-500">Python, MySQL</span>
                                                </td>
                                                <td class="text-right">
                                                                <span
                                                                    class="label label-lg label-light-warning label-inline">In Progress</span>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="pt-5">
                                <p class="text-center font-weight-normal font-size-lg pb-7">Notes: Current
                                ...
                                <div class="table-responsive">
                                    <table
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/media/logos/stars.png" alt="image"
                                                     style="width: 5.5rem"/>
                                                <span
                                                    class="text-muted font-weight-bold d-block font-size-sm">Best Rated</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/media/logos/stars.png"
